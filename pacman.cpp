...
static const float PACKMAN_SPEED            = 120.f; 
static const float PACKMAN_RADIUS           = 16.0f; 
static const float PACKMAN_VISIBLE_RADIUS   = 12.0f; 
static const float PACKMAN_MOUTH_ANGLE      = 110.f; 
